...
* From the cli: 
. SSH to access your bastion host with your OPENTLC login name and private SSH key.

* Example using a Unix/Linux system:
+
----
$ ssh -i /path/to/private_key <YOUR-OPENTLC-USERNAME>@workstation-<YOUR-GUID>.rhpds.opentlc.com
----
